<article <?php post_class(); ?>>
		<?php if ( is_single() ) :
			...
			<div class="entry-box clearfix">
				...
				<?php $thumb = get_the_post_thumbnail( get_the_ID(), 'large', 'class=thumbnail' );
				...
				<p class="more-link-box">
					<a class="more-link" href="<?php the_permalink()?>" title="<?php the_title_attribute(); ?>"><?php _e('Read more', 'basic'); ?></a>
				</p>
				<?php endif; ?>
			</div>
